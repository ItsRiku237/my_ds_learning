...
//without returning head pointer:
struct node
{
    int data;
    struct node *link;
...
// time complexity {O(1)}
void incert_beginning(struct node **head){
    int data;
...
int main(){
    ...
    incert_beginning(&head);//send address of head that help work without return head pointer
